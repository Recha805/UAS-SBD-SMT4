...
<head>
    ...
    <title>Typography | Market Platz Snow</title>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="widgets/../../index.php">ADMIN - PLATZ SNOW</a>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <p class="lead">
                               PLATZ SNOW adalah market yang meyediakan laptop dengan berbagai jenis dan merk.
                            </p>
                            <p>
                               PLATZ SNOW mempunyai karyawan yang selalu membuat anda nyaman dengan pelayanan kami.
                            </p>
                            <p>
                               PLATZ SNOW juga mempunyai wesite yang mudah untuk digunakan, sehinggan para pelanggan bisa dengan mudah mengecek berbagai penawran produk (laptop) terbaru dan terupdate setiap hari. Market kami juga menginfokan melalui berbagai sosial media dan tentunya diwebsite kami perihal penawaran berbagai macam diskon.
                            </p>
                        </div>
                    </div>
                </div>
